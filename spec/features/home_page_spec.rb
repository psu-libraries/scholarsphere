...
RSpec.describe 'Home page', type: :feature do
  context 'with featured resources' do
    ...
    it 'displays the landing page with selected featured works' do
      ...
      expect(page).to have_selector('h3', text: featured_work.resource.latest_published_version.title)
      expect(page).to have_selector('h3', text: featured_work_version.resource.title)
      expect(page).to have_selector('h3', text: featured_collection.resource.title)
