...
RSpec.describe WorkVersionMetadataComponent, type: :component do
  ...
  describe 'fully loaded' do
    ...
    it 'renders every field' do
      ...
      expect(result.css('dt.work-version-work-type')).to be_present
      ...
      expect(result.css('dd.work-version-work-type').text).to eq Work::Types.display(work_version.work_type)
